...
USER_dLIBRARIES = USER_dLIBRARIES | {
    f.name[:-15] for f in (RL_DIR / "user_rotlibs").glob("*drotlib.zip")
}
...
with open(DATA_DIR / "bio_ccd.pkl", "rb") as f:
    bio_ccd = pickle.load(f)
